...
const modifiedFiles = new Set([
  '.gitignore', 'README.md', 'SECURITY_CHECKLIST.md', 'phase8-acceptance.md', 'docs/STAGE1_DEPENDENCY_ADVISORIES.md', 'docs/V2_ENVIRONMENT_INVENTORY.md',
...
const addedFiles = [
  ...
  /^scripts\/(check_clean_clone|check_foundation|check_foundation_manifest|foundation_db_checks|foundation_invariants|local_database|reset_rc_database|schema_fingerprint)\.mjs$/,
  /^src\/app\/api\/(health|readiness)(?:\/|$)/,
  /^src\/lib\/(foundation|foundationContracts|runtimeDatabaseUrl|runtimeTarget)\.(mjs|ts)$/,
  /^test(?:\/|$)/,
  /^vercel\.json$/,
];
