// Architecture: App Router surface src/app/auth/tenant/setup-2fa/page.tsx; composes the user journey for this route and delegates reusable data, validation and state work to shared modules.
'use client';
