// Architecture: App Router surface src/app/rooms/requests/reject/page.tsx; composes the user journey for this route and delegates reusable data, validation and state work to shared modules.
