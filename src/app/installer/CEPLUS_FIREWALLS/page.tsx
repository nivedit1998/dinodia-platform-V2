// Architecture: App Router surface src/app/installer/CEPLUS_FIREWALLS/page.tsx; composes the user journey for this route and delegates reusable data, validation and state work to shared modules.
...
export default async function InstallerCePlusFirewallsPage() {
  ...
  return (
    <CompanyPortalShell username={user.username} role={user.role}>
      <FirewallsClient installerName={user.username} />
    </CompanyPortalShell>
  );
}
