// Architecture: App Router surface src/app/installer/CEPLUS_ASSET_INVENTORY/page.tsx; composes the user journey for this route and delegates reusable data, validation and state work to shared modules.
...
export default async function InstallerCePlusAssetInventoryPage() {
  ...
  return (
    <CompanyPortalShell username={user.username} role={user.role}>
      <AssetInventoryClient installerName={user.username} />
    </CompanyPortalShell>
  );
}
