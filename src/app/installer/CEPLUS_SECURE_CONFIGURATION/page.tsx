// Architecture: App Router surface src/app/installer/CEPLUS_SECURE_CONFIGURATION/page.tsx; composes the user journey for this route and delegates reusable data, validation and state work to shared modules.
...
export default async function InstallerCePlusSecureConfigurationPage() {
  ...
  return (
    <CompanyPortalShell username={user.username} role={user.role}>
      <SecureConfigurationClient installerName={user.username} />
    </CompanyPortalShell>
  );
}
