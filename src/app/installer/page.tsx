...
export default function InstallerPage() {
  ...
  useEffect(() => {
    fetch("/api/installer/workflows", { credentials: "same-origin", cache: "no-store" })
      ...
      .then((body) => { setWorkflows(body.workflows || []); setEmployeeRole(body.employee?.role || ""); setEmployees(body.employees || []); setSessionExpiresAt(body.sessionExpiresAt || null); })
