// Architecture: App Router surface src/app/installer/LOGGING_POLICY/page.tsx; composes the user journey for this route and delegates reusable data, validation and state work to shared modules.
...
export default async function InstallerLoggingPolicyPage() {
  ...
  return (
    <CompanyPortalShell username={user.username} role={user.role}>
      <LoggingPolicyClient installerName={user.username} />
    </CompanyPortalShell>
  );
}
